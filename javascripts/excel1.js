var excels = (function () {
    ...
    //上传监控
    function changeFile(e, name, sex, iphone, email) {
        ...
        fileReader.onload = function (ev) {
            ...
            excel.prototype.dataTables(persons, name, sex, iphone, email)
            //persons为传入的数据值
    ...
    //对表格函数进行封装
    function dataTables(dataset, name, sex, iphone, email) {
